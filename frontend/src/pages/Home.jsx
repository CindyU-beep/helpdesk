...
function Home() {
  return (
    <>
      <div className="relative mx-auto max-w-4xl grid sm:space-y-10">
        <div className="text-center">
          ...
          <h1 className="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-neutral-200">
            Fast, Personalised IT Support for Every Ticket,{' '}
            <span className="leading-loose text-blue-500">Every Time</span>
          </h1>
        </div>
        ...
        <div className="sm:flex sm:justify-center sm:items-center text-center sm:text-start">
          <div className="shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5">
            <div className="flex justify-center -space-x-3">
              ...
              <img
                ...
                alt="Avatar"
              />
              <span className="inline-flex items-center justify-center size-10 rounded-full ring-2 ring-white bg-gray-800 dark:bg-neutral-900 dark:ring-neutral-900">
          ...
          <div className="pt-5 sm:pt-0 sm:ps-5">
            ...
            <div className="text-sm text-gray-500 dark:text-neutral-500">
              Rated best over 1.5k reviews
            </div>
          </div>
        </div>
        <div class="mt-8 gap-3 flex justify-center">
          <Link
            class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-gradient-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 text-white focus:outline-none"
            to="/new-ticket"
          >
            Create New Ticket
            <svg
